...
<?php if ( is_front_page() ) : ?>
    <!-- Ultra-Simple Minimalist Landing Page Footer -->
    <footer style="background: #ffffff; padding: 1rem 0; border-top: 1px solid #e2e8f0; width: 100%;">
        <div class="container" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" style="display: flex; align-items: center;">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/logo.webp' ); ?>" alt="Cleanique Academy" style="height: 38px; width: auto; display: block;">
            </a>
            <div style="font-weight: 700; color: #16a34a; font-size: 0.92rem; letter-spacing: 0.02em;">
...
<div class="floating-actions" style="position: fixed; bottom: 1.5rem; right: 1.5rem; z-index: 9997; display: flex; align-items: flex-end; gap: 0.75rem;">
    
    <!-- Floating Chat Bubble Tooltip -->
    <div id="waFloatingBubble" class="wa-floating-bubble" style="background: #ffffff; color: #0f172a; border: 1px solid #e2e8f0; border-radius: 16px; padding: 0.65rem 0.95rem; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.12); display: flex; align-items: center; gap: 0.6rem; font-size: 0.88rem; font-weight: 600; cursor: pointer;" onclick="if(window.openWaFaqModal){window.openWaFaqModal();}">
        <span>Ada pertanyaan soal pelatihan kimia?</span>
        <button type="button" onclick="event.stopPropagation(); document.getElementById('waFloatingBubble').style.display='none';" style="background: none; border: none; color: #94a3b8; font-size: 1.1rem; cursor: pointer; padding: 0; line-height: 1;" aria-label="Tutup Chat Bubble">&times;</button>
    </div>
