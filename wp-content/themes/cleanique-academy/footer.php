...
<div class="floating-actions">
    ...
    <a href="<?php echo esc_url( cleanique_get_whatsapp_url( 'Halo Cleanique Academy, saya ingin tanya seputar pelatihan.' ) ); ?>" target="_blank" class="floating-btn btn-wa-float" aria-label="Chat WhatsApp">
