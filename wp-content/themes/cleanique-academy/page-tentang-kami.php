...
<!-- 1. SEJARAH, PROFIL PERUSAHAAN & VIDEO PENJELASAN -->
<section class="section">
    <div class="container" style="max-width: 980px;">
        ...
        <div style="margin-bottom: 2.5rem;">
            ...
            <p style="font-size: 1.05rem; line-height: 1.75; color: var(--color-text-muted);">
...
<section id="kontak" class="section section-alt" style="padding: 3.25rem 0;">
    <div class="container" style="max-width: 850px;">
        <div style="background: linear-gradient(135deg, var(--color-secondary) 0%, #1e293b 100%); color: #ffffff; border-radius: 12px; padding: 2.5rem 1.5rem; text-align: center;">
            ...
            <a href="<?php echo esc_url( cleanique_get_whatsapp_url( 'Halo Cleanique Academy, saya ingin konsultasi pendaftaran dari halaman Tentang Kami.' ) ); ?>" target="_blank" class="btn btn-whatsapp" style="padding: 0.8rem 1.75rem; border-radius: 8px;">
