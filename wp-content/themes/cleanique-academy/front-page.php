            ...
            if ( $kegiatan_query->have_posts() ) :
                while ( $kegiatan_query->have_posts() ) : $kegiatan_query->the_post();
                    ...
                    <div class="gallery-overlay-card" 
                         ...
                         data-tanggal="<?php echo esc_attr( $tanggal ? $tanggal : 'Kegiatan Academy' ); ?>"
                        ...
                        <div class="gallery-card-overlay">
                            <div class="gallery-card-content">
                                ...
                                <h3 class="gallery-card-title" style="color: #ffffff; margin-bottom: 0.35rem;"><?php the_title(); ?></h3>
    ...
    <div class="container" style="max-width: 1080px;">
        ...
        <div style="text-align: center; max-width: 800px; margin: 0 auto 2.25rem auto;">
            ...
            <p style="font-size: 0.92rem; line-height: 1.65; color: #94a3b8; margin: 0;">
                Pelatihan tatap muka berbayar diselenggarakan sesuai jadwal batch terkonfirmasi di Training Center Sleman, Yogyakarta setelah pendaftaran. Materi pelatihan pembuatan chemical laundry mengacu pada formula baku komersial yang telah kami riset berdasarkan efisiensi dan standar kualitas industri. Ada dua kelas utama yang dapat Anda pilih:
            </p>
        </div>
