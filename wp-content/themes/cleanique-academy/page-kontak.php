 ...
 *
 * Cleanique Academy - Contact Page Template
...
<section class="about-hero-section" style="background-image: linear-gradient(145deg, rgba(7, 35, 56, 0.94) 0%, rgba(11, 93, 143, 0.90) 60%, rgba(8, 127, 193, 0.86) 100%), url('<?php echo esc_url( get_template_directory_uri() . '/assets/images/hero-lab-practical.jpg' ); ?>');">
    <div class="container about-hero-container">
        <div class="hero-editorial-pill">
            ...
            <span>PUSAT LAYANAN &amp; CUSTOMER CARE</span>
        </div>
        ...
        <p class="about-hero-subtitle">
            Pusat layanan informasi pendaftaran, konsultasi pemilihan paket kelas, dan reservasi jadwal batch pelatihan PT Indotech Berkah Abadi.
        </p>
...
<!-- 2. KARTU INFORMASI KONTAK 3 KOLOM -->
<section class="section section-decorated" style="padding-top: 3.5rem;">
    <div class="container" style="max-width: 1100px;">
        ...
        <div class="grid grid-3" style="margin-bottom: 3.5rem; gap: 1.5rem;">
            ...
            <div class="card" style="height: 100%; padding: 2rem 1.75rem; border-radius: var(--radius-xl);">
                <div class="editorial-badge" style="margin-bottom: 1rem; width: fit-content;">
                    <span class="badge-dot"></span>
                    <span>KANTOR PUSAT</span>
                </div>
                <h3 class="card-title" style="font-size: 1.25rem; margin-bottom: 1rem;">PT Indotech Berkah Abadi</h3>
                
                <p style="margin-bottom: 1rem; font-size: 0.92rem; line-height: 1.6; color: var(--color-text-main);">
                    <strong>Alamat Training Center:</strong><br>
                    <a href="https://share.google/T7jYkSurqjN4cRd5T" target="_blank" rel="noopener" style="color: var(--color-primary); font-weight: 600; text-decoration: underline;">
                        Jongke Tengah No. 30, RT.01/RW.23, Sendangadi, Kec. Mlati, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55285
                    </a>
                </p>

                <p style="margin-bottom: 1.25rem; font-size: 0.92rem; line-height: 1.6; color: var(--color-text-main);">
                ...
                <div style="margin-top: auto;">
                    <a href="https://share.google/T7jYkSurqjN4cRd5T" target="_blank" rel="noopener" class="btn btn-outline" style="padding: 0.45rem 1rem; font-size: 0.85rem; display: inline-flex; align-items: center; gap: 0.4rem; border-radius: var(--radius-full);">
            ...
            <div class="card" style="height: 100%; background: var(--color-primary-light); border-color: #bae6fd; padding: 2rem 1.75rem; border-radius: var(--radius-xl);">
                <div class="editorial-badge" style="margin-bottom: 1rem; width: fit-content; background: #e0f2fe;">
                    <span class="badge-dot"></span>
                    <span>WHATSAPP OFFICIAL</span>
                </div>
                <h3 class="card-title" style="font-size: 1.25rem; margin-bottom: 1rem; color: var(--color-primary-dark);">Saluran Chat Respon Cepat</h3>
                
                <div style="display: flex; flex-direction: column; gap: 0.85rem; font-size: 0.92rem;">
                    <div>
                        <strong style="color: var(--color-secondary); display: block; margin-bottom: 0.4rem;">WhatsApp Customer Care:</strong>
                        <p style="color: var(--color-text-muted); font-size: 0.88rem; margin-bottom: 1.25rem; line-height: 1.55;">Layanan informasi pendaftaran kelas, konsultasi pemilihan formula, dan bimbingan alumni.</p>
                        <div>
                            <a href="<?php echo esc_url( cleanique_get_whatsapp_url( 'Halo Cleanique Academy, saya mau konsultasi pendaftaran pelatihan.' ) ); ?>" target="_blank" class="btn btn-whatsapp" style="font-size: 0.92rem; padding: 0.75rem 1.2rem; display: inline-flex; width: 100%; justify-content: center; border-radius: var(--radius-md);">
            ...
            <div class="card" style="height: 100%; padding: 2rem 1.75rem; border-radius: var(--radius-xl);">
                <div class="editorial-badge" style="margin-bottom: 1rem; width: fit-content;">
                    <span class="badge-dot"></span>
                    <span>EMAIL &amp; SOSMED</span>
                </div>
                <h3 class="card-title" style="font-size: 1.25rem; margin-bottom: 1rem;">Surat Elektronik &amp; Kanal Komunitas</h3>
                
                <p style="margin-bottom: 1.25rem; font-size: 0.92rem; line-height: 1.6;">
                    <strong>Email Resmi:</strong><br>
                    <a href="mailto:indotechberkahabadi@gmail.com" style="color: var(--color-primary); font-weight: 600;">indotechberkahabadi@gmail.com</a>
                </p>

                <div>
                    <strong style="font-size: 0.92rem; display: block; margin-bottom: 0.65rem;">Kanal Media Sosial Resmi:</strong>
                    <div style="display: flex; gap: 0.65rem; align-items: center;">
                        <a href="https://instagram.com/cleaniqueacademy" target="_blank" class="social-icon-link social-ig" aria-label="Instagram">
                        ...
                        <a href="https://www.youtube.com/@orchidcareofficial" target="_blank" class="social-icon-link social-yt" aria-label="YouTube">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                        </a>
                        <a href="https://facebook.com/cleaniqueacademy" target="_blank" class="social-icon-link social-fb" aria-label="Facebook">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a href="https://wa.me/6282215840088" target="_blank" class="social-icon-link social-wa" aria-label="WhatsApp">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-1.157 4.228 4.228-1.157zm12.339-6.495c-.068-.113-.25-.181-.523-.317-.272-.136-1.61-.795-1.86-.886-.25-.091-.432-.136-.613.136-.182.272-.704.886-.863 1.067-.159.182-.318.204-.59.068-.272-.136-1.151-.424-2.193-1.353-.81-.723-1.357-1.616-1.516-1.888-.159-.272-.017-.419.119-.554.122-.122.272-.318.408-.477.136-.159.182-.272.272-.454.091-.182.045-.341-.023-.477-.068-.136-.613-1.477-.84-2.023-.222-.534-.447-.461-.613-.469-.159-.008-.341-.01-.523-.01s-.477.068-.727.341c-.25.272-.954.932-.954 2.273s.977 2.636 1.114 2.818c.136.182 1.923 2.936 4.659 4.116.65.281 1.158.448 1.554.573.653.207 1.247.178 1.716.108.523-.078 1.61-.658 1.838-1.295.227-.636.227-1.181.159-1.295z"/></svg>
                        </a>
                    </div>
                </div>
        ...
        <div style="margin-bottom: 3.5rem;">
            <div class="section-header">
                <div class="editorial-badge">
                    ...
                    <span class="badge-code">KONSULTASI AKADEMI</span>
                </div>
                <h3 class="section-title" style="font-size: 1.65rem; margin-bottom: 0.5rem;">Mengapa Menghubungi Cleanique Academy?</h3>
            ...
            <div class="grid grid-3" style="gap: 1.25rem;">
                ...
                <div class="feature-icon-card">
                    ...
                    <p style="font-size: 0.86rem; color: #64748b; margin: 0; line-height: 1.55;">Diskusikan kebutuhan produk bisnis Anda agar dapat memilih paket kelas yang paling efisien dan tepat sasaran.</p>
                </div>
                <div class="feature-icon-card">
                    ...
                    <h4 style="font-size: 1.05rem; font-weight: 800; color: #0f172a; margin-bottom: 0.4rem;">Kunjungan Langsung Sleman</h4>
                    <p style="font-size: 0.86rem; color: #64748b; margin: 0; line-height: 1.55;">Anda diperbolehkan berkunjung langsung ke Training Center Sleman Yogyakarta sesuai jam kerja operasional kantor.</p>
                </div>
            </div>
        </div>

        <!-- 3. INTERNAL NAVIGATION LINKS GRID -->
        <div style="margin-bottom: 3.5rem; padding-top: 2.5rem; border-top: 1px solid var(--color-border);">
            <div class="section-header">
                <div class="editorial-badge">
                    <span class="badge-dot"></span>
                    <span>INFORMASI TAMBAHAN</span>
                    <span class="badge-code">EKSPLORASI</span>
                </div>
        ...
        <!-- 4. PETA LOKASI TRAINING CENTER YOGYAKARTA -->
        <div class="contact-map-card" style="border-radius: var(--radius-xl); overflow: hidden; border: 1px solid var(--color-border); padding: 2rem; background: #ffffff; box-shadow: var(--shadow-sm);">
            <div class="section-header" style="text-align: center; margin-bottom: 2rem;">
                <div class="editorial-badge">
                    <span class="badge-dot"></span>
                    <span>LOKASI SLEMAN</span>
                    <span class="badge-code">GOOGLE MAPS</span>
                </div>
                <h2 class="section-title" style="font-size: 1.8rem; margin-bottom: 0.5rem;">Peta Training Center Sleman Yogyakarta</h2>
                <div class="section-accent-bar"></div>
                <p class="section-description">Kunjungi Workshop &amp; Pusat Pelatihan Tatap Muka Cleanique Academy (PT Indotech Berkah Abadi).</p>
            </div>

            <div class="contact-map-iframe-wrap" style="height: 380px; border-radius: var(--radius-lg); overflow: hidden; border: 1px solid var(--color-border);">
                <iframe 
            ...
            <div style="text-align: center; margin-top: 1.5rem;">
                <a href="https://share.google/T7jYkSurqjN4cRd5T" target="_blank" rel="noopener" class="btn btn-primary" style="padding: 0.65rem 1.4rem; font-size: 0.92rem; border-radius: var(--radius-md); display: inline-flex; align-items: center; gap: 0.5rem;">
